...
<center><h2 style="text-align: center;">User Registration form </h2>
<form name="Myform" id="Myform" action="RegisterProcess.php" method="post" onsubmit="return(Validate());">
        ...
        <tr>
                ...
                <td><input type="text" name="mobile" id="mobile" maxlength="11" onkeydown="HideError()"/></td>
            
                
                <td><input type="text" name="email" id="email" onkeydown="HideError()"/></td>
            
                
                <td><input type="text" name="password" id="password" onkeydown="HideError()"/></td>
